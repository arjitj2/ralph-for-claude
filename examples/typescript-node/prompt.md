...
Implement ONE task from the PRD, ensure all tests pass, commit your changes, and mark the task complete.
...
For this TypeScript/Node project:
```bash
npm test
...
3. If NO: Simply end your response (the loop will start a fresh iteration)

## Critical Rules

1. **ONE TASK PER ITERATION** - Do not implement multiple tasks
...
- You have a FRESH context each iteration
